...
def pv(loja): u=st.session_state.get("usuario"); return u and u["acesso"] in ("admin","ambas",loja,"operador")
def is_op(): u=st.session_state.get("usuario"); return u and u["acesso"]=="operador"
...
with st.sidebar:
    ...
    roles={"admin":"Admin","ambas":"Ambas","distribuidora":"Distribuidora","sublimacao":"Sublimacao","operador":"Operador"}
...
def pagina_admin():
    ...
    with tab_u:
        ...
        with st.form("fnu"):
            ...
            acesso=c4.selectbox("Acesso",["operador","distribuidora","sublimacao","ambas","admin"],format_func=lambda x:{"operador":"Operador (só adiciona)","distribuidora":"Só Distribuidora","sublimacao":"Só Sublimação","ambas":"Ambas as Lojas","admin":"Administrador"}[x])
